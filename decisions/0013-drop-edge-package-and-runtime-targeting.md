...
- The downstream framework adapter (`@postel/hono`) and the standalone storage dedup adapters (`@postel/pg`, `@postel/sqlite`) switch their `@postel/edge` imports to `@postel/core`.
