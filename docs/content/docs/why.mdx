...
If you skipped here from [Is Postel for me?](/docs/is-postel-for-me): this page is the long version of the same content. The fast filter is there; the rationale is here.
...
|---|---|---|---|---|
| Sender — outbox, retries, replay | ✅ | ⚠️ DIY | ❌ | ✅ (v0.2) |
...
- [Is Postel for me?](/docs/is-postel-for-me) — the fast filter.
- [Quickstart](/docs/quickstart) — verify your first webhook.
- [Polyglot](/docs/polyglot) — the language-port roadmap.
