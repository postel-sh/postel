...
|---|---|---|
| Sustained deliveries/sec | ~360–400 | ≥ 150 |

The spec floor (150/sec) is set with headroom below the measured number so `mise run bench`'s CI-gated variant doesn't flake on a slower runner — it is a contractual minimum, not the expected number.
