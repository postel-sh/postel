...
The contract is the suite — not prose, not promises. See [Reference → Specs & standards](/docs/project/specs).

## Read next

- [Reference → Specs & standards](/docs/project/specs) — the canonical artifacts.
- [Why Postel](/docs/project/why) — why polyglot matters for this kind of library.
