...
|---|---|---|---|
| **TypeScript** | Receiver: shipping (`0.0.0`). Sender: shipping in `0.2.0` (in-memory adapter; DB adapters next). | [`postel-sh/postel`](https://github.com/postel-sh/postel) (this repo, `typescript/`) | Reference implementation. The other ports gate on passing the same compliance suite at the same version. |
...
3. Port is announced as a v0.X release.
