...
|---|---|---|---|
| **TypeScript** | Receiver: shipping (`0.0.0`). Sender: planned v0.2. | [`postel-sh/postel`](https://github.com/postel-sh/postel) (this repo, `typescript/`) | Reference implementation. The other ports gate on passing the same compliance suite at the same version. |
