...
`autoMigrate` runs the canonical migrations for the configured dialect through your DataSource (version-gated, idempotent). Or run your own tooling against the [canonical schema](/docs/storage/schema).
