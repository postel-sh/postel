---
title: Replay
description: First-class replay verbs — by message id, by endpoint + time range, or by custom filter. Planned for v0.2.0.
---

> **Status: planned — v0.2.0.** Types ship today; the runtime throws `NotImplementedError`.
