...
description: Retry strategies, circuit breakers, and auto-disable for persistently failing endpoints. Planned for v0.2.0.
---

> **Status: planned — v0.2.0.** Types ship today; the runtime throws `NotImplementedError`. This page documents the *target* shape.
