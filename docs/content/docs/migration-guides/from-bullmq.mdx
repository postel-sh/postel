...
| Bull Board / a custom admin page for inspecting jobs | [`@postel/admin`](/docs/operations/admin)'s `GET /messages`, `GET /messages/:id/attempts` |
...
8. Point any internal dashboard at [`@postel/admin`](/docs/operations/admin)'s `GET /messages` and `GET /messages/:id/attempts` instead of a Bull Board instance.
