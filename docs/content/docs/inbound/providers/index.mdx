...
<Cards>
  <Card title="Stripe" href="/docs/inbound/providers/stripe" description="Stripe-Signature: t= + v1= HMAC-SHA256, ±300s window, secret rolls." />
  <Card title="GitHub" href="/docs/inbound/providers/github" description="X-Hub-Signature-256 over the raw payload; type from X-GitHub-Event." />
  <Card title="Shopify" href="/docs/inbound/providers/shopify" description="Base64 HMAC in X-Shopify-Hmac-Sha256; topic from X-Shopify-Topic." />
  <Card title="Twilio" href="/docs/inbound/providers/twilio" description="SHA-1 over URL + sorted form params — the exact registered URL matters." />
  <Card title="Slack" href="/docs/inbound/providers/slack" description="v0 signing scheme with its own ±300s timestamp window." />
</Cards>
