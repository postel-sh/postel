...
| Express, Fastify, Next.js, Bun adapters | Stub packages today (`__postelPackage` only); proper releases planned | `@postel/express`, `@postel/fastify`, `@postel/nextjs`, `@postel/bun` |
