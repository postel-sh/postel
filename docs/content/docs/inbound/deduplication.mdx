...
This is exactly the pattern the v0.2.0 [outbound](/docs/outbound) sender will use for outbox inserts — the receiver's dedup row is the mirror image of the sender's outbox row.
